...
if page == "Project Overview":
    ...
    st.markdown(
        ...
        "predicted sale prices differ from actual "
        "sale prices by approximately **\\$17,954 on average**."
    )

    st.markdown(
        "The **Root Mean Squared Error of \\$29,149.13** is "
        "higher than the MAE because it gives greater "
